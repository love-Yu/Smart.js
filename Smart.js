...
$(function () {
    ...
    Smart.extend({
        /**
         *对一个jsonArray对象进行排序,以其中的某个key为标准
         *这个key目前支持阿拉伯数字排序.
         * @param {jsonArray} jsonArray jsonArray对象
         * @param {String} key
         */
        quickSort: function (jsonArray, key) {
            ...
            return Smart.quickSort(left).concat(jsonArray0, Smart.quickSort(right));
        },
        ...
        quickSortArray: function (array) {
            ...
            return Smart.quickSortArray(left).concat([pivot], Smart.quickSortArray(right));
